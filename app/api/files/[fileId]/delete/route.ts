        ...
        if (imagekitFileId) {
          try {
            ...
            if (searchResults && searchResults.length > 0) {
              ...
              // Narrow the type — only FileObject has fileId
              if ("fileId" in firstItem && firstItem.fileId) {
                await imagekit.deleteFile(firstItem.fileId);
              } else {
                console.warn("The matched item is not a file, skipping ImageKit deletion.");
              }
            } else {
